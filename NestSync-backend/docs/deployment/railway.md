...
See [Environment Configuration](./environment.md) for complete list of environment variables.
...
- [Supabase Integration](./supabase.md) - Database and authentication setup
