"""create emergency flows tables

Revision ID: 0ad4eb18cfed
Revises: eba9f5da5300
Create Date: 2025-09-18 01:05:30.336794-04:00
...
revision = '0ad4eb18cfed'
down_revision = 'eba9f5da5300'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('family_id', sa.UUID(), nullable=False, comment='Family that owns this emergency access'),
    sa.Column('child_id', sa.UUID(), nullable=True, comment='Specific child (if null, access to all family children)'),
    sa.Column('created_by', sa.UUID(), nullable=False, comment='User who created this access token'),
    sa.Column('access_token', sa.String(length=64), nullable=False, comment='Unique access token for emergency access'),
    sa.Column('access_code', sa.String(length=8), nullable=False, comment='Short human-readable access code'),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=False, comment='When this access token expires'),
    sa.Column('is_active', sa.Boolean(), nullable=False, comment='Whether this access token is currently active'),
    sa.Column('max_uses', sa.Integer(), nullable=True, comment='Maximum number of times this token can be used (null = unlimited)'),
    sa.Column('use_count', sa.Integer(), nullable=False, comment='Number of times this token has been accessed'),
    sa.Column('can_view_medical', sa.Boolean(), nullable=False, comment='Can view medical information'),
    sa.Column('can_view_contacts', sa.Boolean(), nullable=False, comment='Can view emergency contacts'),
    sa.Column('can_view_providers', sa.Boolean(), nullable=False, comment='Can view healthcare providers'),
    sa.Column('can_view_location', sa.Boolean(), nullable=False, comment="Can view child's current location (if available)"),
    sa.Column('recipient_name', sa.String(length=100), nullable=True, comment='Name of person this access is intended for'),
    sa.Column('recipient_phone', sa.String(length=20), nullable=True, comment='Phone number of recipient'),
    sa.Column('recipient_relationship', sa.String(length=50), nullable=True, comment='Relationship to child (babysitter, grandparent, etc.)'),
    sa.Column('purpose', sa.String(length=255), nullable=True, comment='Purpose of this emergency access'),
    sa.Column('notes', sa.String(length=500), nullable=True, comment='Additional notes or instructions'),
    sa.Column('access_log', sa.JSON(), nullable=True, comment='Log of all access attempts and views'),
    sa.Column('last_accessed_at', sa.DateTime(timezone=True), nullable=True, comment='Last time this token was successfully used'),
    sa.Column('revoked_at', sa.DateTime(timezone=True), nullable=True, comment='When this token was revoked (if applicable)'),
    sa.Column('revoked_by', sa.UUID(), nullable=True, comment='User who revoked this access'),
    sa.Column('qr_code_data', sa.JSON(), nullable=True, comment='Cached QR code generation data'),
    sa.Column('id', sa.UUID(), nullable=False, comment='Unique identifier'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='Record creation timestamp (UTC)'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='Record last update timestamp (UTC)'),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True, comment='Soft delete timestamp (PIPEDA compliance)'),
    ...
    with op.batch_alter_table('emergency_access', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_emergency_access_access_code'), ['access_code'], unique=True)
        batch_op.create_index(batch_op.f('ix_emergency_access_access_token'), ['access_token'], unique=True)
        batch_op.create_index(batch_op.f('ix_emergency_access_child_id'), ['child_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_emergency_access_created_by'), ['created_by'], unique=False)
        batch_op.create_index(batch_op.f('ix_emergency_access_family_id'), ['family_id'], unique=False)

    op.create_table('emergency_contacts',
    sa.Column('child_id', sa.UUID(), nullable=False, comment='Child this emergency contact belongs to'),
    sa.Column('family_id', sa.UUID(), nullable=False, comment='Family this emergency contact belongs to'),
    sa.Column('name', sa.String(length=100), nullable=False, comment='Full name of emergency contact'),
    sa.Column('relationship_to_child', sa.String(length=50), nullable=False, comment='Relationship to child (e.g., grandmother, aunt, family friend)'),
    sa.Column('phone_primary', sa.String(length=20), nullable=False, comment='Primary phone number with country code'),
    sa.Column('phone_secondary', sa.String(length=20), nullable=True, comment='Secondary/alternate phone number'),
    sa.Column('email', sa.String(length=255), nullable=True, comment='Email address for non-urgent communication'),
    sa.Column('is_primary', sa.Boolean(), nullable=False, comment='Primary emergency contact to call first'),
    sa.Column('priority_order', sa.Integer(), nullable=False, comment='Order in which to contact (1 = first, 2 = second, etc.)'),
    sa.Column('address', sa.Text(), nullable=True, comment='Physical address of contact'),
    sa.Column('notes', sa.Text(), nullable=True, comment='Additional notes (e.g., availability, best times to reach)'),
    sa.Column('can_pickup', sa.Boolean(), nullable=False, comment='Authorized to pick up child from daycare/school'),
    sa.Column('can_make_medical_decisions', sa.Boolean(), nullable=False, comment='Authorized to make medical decisions in parent absence'),
    sa.Column('province', sa.String(length=2), nullable=True, comment='Province/territory code (ON, BC, QC, etc.)'),
    sa.Column('speaks_french', sa.Boolean(), nullable=False, comment='Contact speaks French (relevant for Quebec and bilingual regions)'),
    sa.Column('speaks_english', sa.Boolean(), nullable=False, comment='Contact speaks English'),
    sa.Column('last_verified_at', sa.DateTime(timezone=True), nullable=True, comment='Last date contact information was verified'),
    sa.Column('consent_given_at', sa.DateTime(timezone=True), nullable=True, comment='Date consent was given to be emergency contact'),
    sa.Column('id', sa.UUID(), nullable=False, comment='Unique identifier'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='Record creation timestamp (UTC)'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='Record last update timestamp (UTC)'),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True, comment='Soft delete timestamp (PIPEDA compliance)'),
    ...
    with op.batch_alter_table('emergency_contacts', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_emergency_contacts_child_id'), ['child_id'], unique=False)
    ...
    sa.Column('child_id', sa.UUID(), nullable=False, comment='Child this healthcare provider serves'),
    sa.Column('family_id', sa.UUID(), nullable=False, comment='Family for access control'),
    sa.Column('provider_type', sa.String(length=30), nullable=False, comment='Type of healthcare provider'),
    sa.Column('is_primary', sa.Boolean(), nullable=False, comment='Primary care provider for this child'),
    sa.Column('provider_name', sa.String(length=100), nullable=False, comment='Name of the doctor or healthcare provider'),
    sa.Column('clinic_name', sa.String(length=100), nullable=True, comment='Name of clinic or hospital'),
    sa.Column('specialty', sa.String(length=100), nullable=True, comment='Medical specialty if applicable'),
    sa.Column('phone', sa.String(length=20), nullable=False, comment='Main phone number'),
    sa.Column('phone_emergency', sa.String(length=20), nullable=True, comment='Emergency or after-hours phone number'),
    sa.Column('fax', sa.String(length=20), nullable=True, comment='Fax number for medical records'),
    sa.Column('email', sa.String(length=255), nullable=True, comment='Email for non-urgent communication'),
    sa.Column('address_line1', sa.String(length=255), nullable=False, comment='Street address'),
    sa.Column('address_line2', sa.String(length=255), nullable=True, comment='Suite, floor, building'),
    sa.Column('city', sa.String(length=100), nullable=False, comment='City'),
    sa.Column('province', sa.String(length=2), nullable=False, comment='Province/territory code'),
    sa.Column('postal_code', sa.String(length=10), nullable=False, comment='Postal code'),
    sa.Column('office_hours', sa.Text(), nullable=True, comment='Office hours and availability'),
    sa.Column('appointment_booking_url', sa.String(length=255), nullable=True, comment='Online appointment booking URL'),
    sa.Column('patient_portal_url', sa.String(length=255), nullable=True, comment='Patient portal or online records URL'),
    sa.Column('notes', sa.Text(), nullable=True, comment='Additional notes (parking, accessibility, etc.)'),
    sa.Column('accepts_provincial_coverage', sa.Boolean(), nullable=False, comment='Accepts provincial health insurance'),
    sa.Column('languages_spoken', sa.Text(), nullable=True, comment='Languages spoken at the practice'),
    sa.Column('referral_required', sa.Boolean(), nullable=False, comment='Requires referral from family doctor'),
    sa.Column('last_visit_date', sa.DateTime(timezone=True), nullable=True, comment='Date of last visit'),
    sa.Column('next_appointment_date', sa.DateTime(timezone=True), nullable=True, comment='Date of next scheduled appointment'),
    sa.Column('patient_id', sa.String(length=50), nullable=True, comment='Patient ID at this provider'),
    sa.Column('id', sa.UUID(), nullable=False, comment='Unique identifier'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='Record creation timestamp (UTC)'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='Record last update timestamp (UTC)'),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True, comment='Soft delete timestamp (PIPEDA compliance)'),
    ...
    with op.batch_alter_table('healthcare_providers', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_healthcare_providers_child_id'), ['child_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_healthcare_providers_family_id'), ['family_id'], unique=False)

    op.create_table('medical_information',
    sa.Column('child_id', sa.UUID(), nullable=False, comment='Child this medical information belongs to'),
    sa.Column('family_id', sa.UUID(), nullable=False, comment='Family for access control'),
    sa.Column('blood_type', sa.String(length=10), nullable=True, comment='Blood type (A+, A-, B+, B-, AB+, AB-, O+, O-, Unknown)'),
    sa.Column('allergies', sa.JSON(), nullable=True, comment='List of allergies with severity and reactions'),
    sa.Column('has_epipen', sa.Boolean(), nullable=False, comment='Child carries or requires EpiPen'),
    sa.Column('medications', sa.JSON(), nullable=True, comment='Current medications with dosage and schedule'),
    sa.Column('medical_conditions', sa.JSON(), nullable=True, comment='Chronic or significant medical conditions'),
    sa.Column('health_card_number', sa.String(length=20), nullable=True, comment='Provincial health card number (encrypted)'),
    sa.Column('health_card_province', sa.String(length=2), nullable=True, comment='Province/territory that issued health card'),
    sa.Column('health_card_expiry', sa.Date(), nullable=True, comment='Health card expiration date'),
    sa.Column('health_card_version', sa.String(length=5), nullable=True, comment='Version code for health card (if applicable)'),
    sa.Column('immunizations', sa.JSON(), nullable=True, comment='Immunization history with dates'),
    sa.Column('emergency_notes', sa.Text(), nullable=True, comment='Critical information for emergency responders'),
    sa.Column('special_instructions', sa.Text(), nullable=True, comment='Special medical instructions or procedures'),
    sa.Column('medical_devices', sa.JSON(), nullable=True, comment='Medical devices used by child'),
    sa.Column('private_insurance_provider', sa.String(length=100), nullable=True, comment='Private insurance company name'),
    sa.Column('private_insurance_number', sa.String(length=50), nullable=True, comment='Private insurance policy number'),
    sa.Column('surgeries_procedures', sa.JSON(), nullable=True, comment='Past surgeries and major procedures'),
    sa.Column('hospitalizations', sa.JSON(), nullable=True, comment='Past hospitalizations with dates and reasons'),
    sa.Column('last_updated_by', sa.UUID(), nullable=True, comment='User who last updated medical information'),
    sa.Column('last_verified_at', sa.Date(), nullable=True, comment='Date medical information was last verified'),
    sa.Column('consent_to_share_with_providers', sa.Boolean(), nullable=False, comment='Consent to share with healthcare providers'),
    sa.Column('id', sa.UUID(), nullable=False, comment='Unique identifier'),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, comment='Record creation timestamp (UTC)'),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, comment='Record last update timestamp (UTC)'),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True, comment='Soft delete timestamp (PIPEDA compliance)'),
    ...
    with op.batch_alter_table('medical_information', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_medical_information_child_id'), ['child_id'], unique=True)
        batch_op.create_index(batch_op.f('ix_medical_information_family_id'), ['family_id'], unique=False)
    ...
    with op.batch_alter_table('children', schema=None) as batch_op:
        ...
        batch_op.alter_column('family_id',
               existing_type=sa.UUID(),
               comment='Family ID for collaboration',
               existing_nullable=True)
        batch_op.alter_column('migrated_from_user',
               existing_type=sa.UUID(),
               comment='Original parent user ID before family migration',
               existing_nullable=True)
        batch_op.drop_index('idx_children_current_size')
        batch_op.drop_index('idx_children_date_of_birth')
        batch_op.drop_index('idx_children_family')
        ...
        batch_op.drop_constraint('children_family_id_fkey', type_='foreignkey')
    ...
    with op.batch_alter_table('collaboration_logs', schema=None) as batch_op:
        ...
        batch_op.alter_column('action_type',
               existing_type=postgresql.ENUM('FAMILY_CREATED', 'FAMILY_UPDATED', 'FAMILY_DELETED', 'MEMBER_INVITED', 'MEMBER_JOINED', 'MEMBER_LEFT', 'MEMBER_REMOVED', 'MEMBER_ROLE_CHANGED', 'CHILD_ADDED', 'CHILD_REMOVED', 'ACTIVITY_LOGGED', 'ACTIVITY_UPDATED', 'ACTIVITY_DELETED', 'DATA_SHARED', 'DATA_EXPORT', 'SETTINGS_CHANGED', name='logaction'),
               comment='Type of action performed',
               existing_nullable=False)
        batch_op.alter_column('target_type',
               existing_type=sa.VARCHAR(length=50),
               comment='Type of target object (child, member, etc.)',
               existing_nullable=True)
        batch_op.alter_column('target_id',
               existing_type=sa.UUID(),
               comment='ID of target object',
               existing_nullable=True)
        ...
        batch_op.alter_column('deleted_by',
               ...
               existing_nullable=True)
        batch_op.drop_index('idx_collaboration_logs_actor')
        batch_op.drop_index('idx_collaboration_logs_family')
        batch_op.drop_index('idx_collaboration_logs_target')
    ...
    with op.batch_alter_table('families', schema=None) as batch_op:
        batch_op.alter_column('name',
               ...
               comment='Family name',
               existing_nullable=False)
        batch_op.alter_column('family_type',
               existing_type=postgresql.ENUM('PERSONAL', 'STANDARD', 'INSTITUTIONAL', name='familytype'),
               comment='Type of family (personal/standard/institutional)',
               existing_nullable=False)
        ...
        batch_op.alter_column('created_by',
               existing_type=sa.UUID(),
               comment='User who created the family',
               existing_nullable=False)
        batch_op.alter_column('settings',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               comment='Family settings and preferences',
               existing_nullable=False)
        batch_op.alter_column('id',
               existing_type=sa.UUID(),
               server_default=None,
    ...
    with op.batch_alter_table('family_child_access', schema=None) as batch_op:
        ...
        batch_op.alter_column('access_level',
               existing_type=postgresql.ENUM('FULL', 'LIMITED', 'READ_ONLY', 'EMERGENCY_ONLY', name='accesslevel'),
               comment='Level of access to child data',
               existing_nullable=False)
        ...
        batch_op.alter_column('deleted_by',
               ...
               comment='User who deleted this record',
               existing_nullable=True)
        batch_op.drop_constraint('family_child_access_family_id_child_id_key', type_='unique')
        batch_op.create_unique_constraint('uq_family_child_access', ['family_id', 'child_id'])
    ...
    with op.batch_alter_table('family_members', schema=None) as batch_op:
        ...
        batch_op.alter_column('role',
               existing_type=postgresql.ENUM('FAMILY_CORE', 'PARTNER', 'CAREGIVER', 'TEMPORARY_CAREGIVER', 'EMERGENCY_CONTACT', name='memberrole'),
               comment='Member role in family',
               existing_nullable=False)
        batch_op.alter_column('permissions',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               comment='Specific permissions for this member',
               existing_nullable=False)
        batch_op.alter_column('joined_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               comment='When member joined family',
               existing_nullable=False)
        batch_op.alter_column('access_expires_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               comment='When member access expires (for temporary access)',
               existing_nullable=True)
        ...
        batch_op.alter_column('status',
               existing_type=postgresql.ENUM('ACTIVE', 'INVITED', 'INACTIVE', 'REMOVED', name='memberstatus'),
        ...
        batch_op.alter_column('deleted_by',
               ...
               comment='User who deleted this record',
               existing_nullable=True)
        batch_op.drop_constraint('family_members_user_id_family_id_key', type_='unique')
        ...
        batch_op.create_unique_constraint('uq_family_member', ['user_id', 'family_id'])
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('family_members', schema=None) as batch_op:
        batch_op.drop_constraint('uq_family_member', type_='unique')
        batch_op.drop_index('idx_family_members_status')
        batch_op.drop_index('idx_family_members_role')
        batch_op.create_unique_constraint('family_members_user_id_family_id_key', ['user_id', 'family_id'], postgresql_nulls_not_distinct=False)
        batch_op.alter_column('deleted_by',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='User who deleted this record',
        ...
        batch_op.alter_column('status',
               existing_type=postgresql.ENUM('ACTIVE', 'INVITED', 'INACTIVE', 'REMOVED', name='memberstatus'),
               comment=None,
               existing_comment='Member status',
               existing_nullable=False)
        batch_op.alter_column('invited_by',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='User who invited this member',
               existing_nullable=True)
        batch_op.alter_column('access_expires_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               comment=None,
               existing_comment='When member access expires (for temporary access)',
               existing_nullable=True)
        batch_op.alter_column('joined_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               comment=None,
               existing_comment='When member joined family',
               existing_nullable=False)
        batch_op.alter_column('permissions',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               comment=None,
               existing_comment='Specific permissions for this member',
               existing_nullable=False)
        batch_op.alter_column('role',
               existing_type=postgresql.ENUM('FAMILY_CORE', 'PARTNER', 'CAREGIVER', 'TEMPORARY_CAREGIVER', 'EMERGENCY_CONTACT', name='memberrole'),
               comment=None,
               existing_comment='Member role in family',
               existing_nullable=False)
        batch_op.alter_column('family_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Family ID',
               existing_nullable=False)
        batch_op.alter_column('user_id',
               existing_type=sa.UUID(),
               comment=None,
    ...
    with op.batch_alter_table('family_child_access', schema=None) as batch_op:
        batch_op.drop_constraint('uq_family_child_access', type_='unique')
        batch_op.create_unique_constraint('family_child_access_family_id_child_id_key', ['family_id', 'child_id'], postgresql_nulls_not_distinct=False)
        batch_op.alter_column('deleted_by',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='User who deleted this record',
        ...
        batch_op.alter_column('granted_by',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='User who granted access',
               existing_nullable=False)
        batch_op.alter_column('granted_at',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               comment=None,
               existing_comment='When access was granted',
               existing_nullable=False)
        batch_op.alter_column('access_level',
               existing_type=postgresql.ENUM('FULL', 'LIMITED', 'READ_ONLY', 'EMERGENCY_ONLY', name='accesslevel'),
               comment=None,
               existing_comment='Level of access to child data',
               existing_nullable=False)
        batch_op.alter_column('child_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Child ID',
               existing_nullable=False)
        batch_op.alter_column('family_id',
               existing_type=sa.UUID(),
               comment=None,
    ...
    with op.batch_alter_table('families', schema=None) as batch_op:
        ...
        batch_op.alter_column('settings',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               comment=None,
               existing_comment='Family settings and preferences',
               existing_nullable=False)
        batch_op.alter_column('created_by',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='User who created the family',
               existing_nullable=False)
        batch_op.alter_column('description',
               existing_type=sa.TEXT(),
               comment=None,
               existing_comment='Family description',
               existing_nullable=True)
        batch_op.alter_column('family_type',
               existing_type=postgresql.ENUM('PERSONAL', 'STANDARD', 'INSTITUTIONAL', name='familytype'),
               comment=None,
               existing_comment='Type of family (personal/standard/institutional)',
               existing_nullable=False)
        batch_op.alter_column('name',
               existing_type=sa.VARCHAR(length=255),
               comment=None,
               existing_comment='Family name',
               existing_nullable=False)
    ...
    with op.batch_alter_table('collaboration_logs', schema=None) as batch_op:
        ...
        batch_op.alter_column('ip_address',
               ...
               comment=None,
               existing_comment='IP address of request',
               existing_nullable=True)
        batch_op.alter_column('details',
               existing_type=postgresql.JSON(astext_type=sa.Text()),
               comment=None,
               existing_comment='Action details and metadata',
               existing_nullable=False)
        batch_op.alter_column('target_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='ID of target object',
               existing_nullable=True)
        batch_op.alter_column('target_type',
               existing_type=sa.VARCHAR(length=50),
               comment=None,
               existing_comment='Type of target object (child, member, etc.)',
               existing_nullable=True)
        batch_op.alter_column('action_type',
               existing_type=postgresql.ENUM('FAMILY_CREATED', 'FAMILY_UPDATED', 'FAMILY_DELETED', 'MEMBER_INVITED', 'MEMBER_JOINED', 'MEMBER_LEFT', 'MEMBER_REMOVED', 'MEMBER_ROLE_CHANGED', 'CHILD_ADDED', 'CHILD_REMOVED', 'ACTIVITY_LOGGED', 'ACTIVITY_UPDATED', 'ACTIVITY_DELETED', 'DATA_SHARED', 'DATA_EXPORT', 'SETTINGS_CHANGED', name='logaction'),
               comment=None,
               existing_comment='Type of action performed',
               existing_nullable=False)
        batch_op.alter_column('actor_user_id',
               existing_type=sa.UUID(),
               nullable=False,
               comment=None,
               existing_comment='User who performed the action')
        batch_op.alter_column('family_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Family ID',
    ...
    with op.batch_alter_table('children', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('children_family_id_fkey', 'families', ['family_id'], ['id'])
        ...
        batch_op.alter_column('migrated_from_user',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Original parent user ID before family migration',
               existing_nullable=True)
        batch_op.alter_column('family_id',
               existing_type=sa.UUID(),
               comment=None,
               existing_comment='Family ID for collaboration',
               existing_nullable=True)
        batch_op.alter_column('parent_id',
               existing_type=sa.UUID(),
    ...
    with op.batch_alter_table('medical_information', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_medical_information_family_id'))
        batch_op.drop_index(batch_op.f('ix_medical_information_child_id'))

    op.drop_table('medical_information')
    with op.batch_alter_table('healthcare_providers', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_healthcare_providers_family_id'))
        batch_op.drop_index(batch_op.f('ix_healthcare_providers_child_id'))

    op.drop_table('healthcare_providers')
    with op.batch_alter_table('emergency_contacts', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_emergency_contacts_family_id'))
        batch_op.drop_index(batch_op.f('ix_emergency_contacts_child_id'))

    op.drop_table('emergency_contacts')
    with op.batch_alter_table('emergency_access', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_emergency_access_family_id'))
        batch_op.drop_index(batch_op.f('ix_emergency_access_created_by'))
        batch_op.drop_index(batch_op.f('ix_emergency_access_child_id'))
        batch_op.drop_index(batch_op.f('ix_emergency_access_access_token'))
        batch_op.drop_index(batch_op.f('ix_emergency_access_access_code'))
