...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Enter valid password in password input field
        ...
        try:
            ...
            raise AssertionError('Test case failed: User was unable to log in with correct email and password, or session was not properly established as per the test plan.')
