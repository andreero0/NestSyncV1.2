...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Consent audit report is fully compliant with all privacy regulations').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError('Test case failed: Consent management did not respect user privacy choices or maintain accurate audit trails as required by the test plan.')
