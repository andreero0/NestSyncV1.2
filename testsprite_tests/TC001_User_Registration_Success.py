...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Registration Completed Successfully! Welcome Aboard')).to_be_visible(timeout=30000)
        except AssertionError:
            raise AssertionError('Test case failed: The registration success message was not displayed and the user was not redirected to onboarding as expected.')
