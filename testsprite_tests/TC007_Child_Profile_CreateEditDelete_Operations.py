...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution failed to verify creating, editing, and deleting child profiles with appropriate confirmations.")
