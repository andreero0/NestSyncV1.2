...
async def run_test():
    ...
    try:
        ...
        # -> Enter a registered email and incorrect password.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login did not fail as expected with incorrect password. The error message indicating invalid credentials was not shown, or navigation occurred unexpectedly.')
