...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password, then click Sign In to access reorder suggestions page.
        ...
        try:
            ...
            raise AssertionError('Test case failed: Emergency order modal did not open correctly or order confirmation was not shown as expected.')
