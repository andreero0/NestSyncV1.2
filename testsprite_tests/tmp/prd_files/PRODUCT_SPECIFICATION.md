...
**Standard Tier ($4.99 CAD/month or $49.99 CAD/year)**:
- ML-powered reorder predictions
- Automated purchase suggestions
- Unlimited children profiles
- Family collaboration (2 adults)
...
**Value Proposition**: "Save 2-4 hours monthly on diaper shopping and planning. Optimize purchases to save $10-20 monthly on diaper spend."

**Premium Tier ($6.99 CAD/month or $69.99 CAD/year)**:
- Everything in Standard
- Advanced family collaboration (unlimited adults)
- Multi-household coordination
- Bulk purchase optimization
- Custom automation rules
- Export data capabilities (CSV/PDF)
- Premium integrations
- API access (Planned)
- Dedicated support

**Value Proposition**: "Advanced coordination and automation for busy families. Professional-grade features at an affordable family price."

### Revenue Model

**Primary Revenue**: Subscription fees
- Target: 70% Standard, 30% Premium adoption
- Annual billing discount: 17% savings
- Family plan positioning for multi-child households
...
- Premium vs baby apps (sophisticated features justify pricing)
- Value vs inventory apps (family-focused simplicity)
