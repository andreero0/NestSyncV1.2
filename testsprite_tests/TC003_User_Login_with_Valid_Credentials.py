...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click on the Sign In button to submit login form
        ...
        try:
            ...
            raise AssertionError('Test case failed: The registered user could not login successfully and was not redirected to the main dashboard as expected.')
