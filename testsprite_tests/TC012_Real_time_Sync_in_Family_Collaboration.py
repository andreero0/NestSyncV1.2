...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: The added activities and inventory changes did not propagate in real-time to other family member accounts with appropriate role-based access as expected.")
