...
const SCREENSHOT_DIR = path.join(__dirname, '../../.kiro/specs/design-consistency-fix/audit-screenshots/reference');
...
async function captureReferenceScreens() {
  ...
  try {
    ...
    await page.goto(`${BASE_URL}/profile-settings`, { waitUntil: 'networkidle', timeout: 30000 });
    await page.waitForTimeout(2000);
    await page.screenshot({
